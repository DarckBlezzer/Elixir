...
defmodule Zipper do
  ...
  def left(zipper = %Zipper{focus: %{left: left} = node, trail: trail}),
    do: %{zipper | focus: left, trail: [{:left, node} | trail]}
  ...
  def right(zipper = %Zipper{focus: node = %{right: right}, trail: trail}) do
  ...
  def up(%Zipper{trail: [{_, node_up} | trail]} = zipper),
    do: %{zipper | focus: node_up, trail: trail}

  @doc """
  Set the value of the focus node.
  """
  @spec set_value(Zipper.t(), any) :: Zipper.t()
  def set_value(zipper = %Zipper{focus: node, trail: trail}, value),
    do: update_zipper(%{zipper | focus: %{node | value: value}}, trail)

  @doc """
  Replace the left child tree of the focus node.
  """
  @spec set_left(Zipper.t(), BinTree.t() | nil) :: Zipper.t()
  def set_left(%Zipper{focus: node, trail: trail} = zipper, left),
    do: update_zipper(%{zipper | focus: %{node | left: left}}, trail)

  @doc """
  Replace the right child tree of the focus node.
  """
  @spec set_right(Zipper.t(), BinTree.t() | nil) :: Zipper.t()
  def set_right(%Zipper{focus: node, trail: trail} = zipper, right),
    do: update_zipper(%{zipper | focus: %{node | right: right}}, trail)
